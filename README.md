...
![A car with a turret mounted on its roof](docs/images/turretoncar.png | width=600)
...
![The Epic Games Launcher](docs/images/epiclauncher.png | width=600)
...
![The Fab marketplace page for the turret asset](docs/images/fabturret.png | width=600)
...
![Adding the poseable mesh component in the Blueprint editor](docs/images/addposeablemesh.png | width=600)
...
![The turret's bone hierarchy](docs/images/turretbones.png | width=600)
![The turret socket at the end of the barrel](docs/images/turretsocket.png | width=600)
...
![The Blueprint graph for turret rotation](docs/images/turretrotation.png | width=600)
...
![The input settings for the fire weapon action](docs/images/input.png | width=600)
...
![The Blueprint graph for firing the projectile](docs/images/fire.png | width=600)
...
![The impulse setting in the projectile Blueprint](docs/images/impulseprojectile.png | width=600)
